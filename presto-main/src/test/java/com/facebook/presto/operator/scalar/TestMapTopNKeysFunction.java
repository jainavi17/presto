        ...
        extends AbstractTestFunctions
{
    ...
    {
        assertFunction("MAP_TOP_N_KEYS(MAP(ARRAY[1, 2, 3], ARRAY[4, 5, 6]), -1)", new ArrayType(INTEGER), asList());
        assertFunction("MAP_TOP_N_KEYS(MAP(ARRAY['a', 'b', 'c'], ARRAY[4, 5, 6]), -2)", new ArrayType(createVarcharType(1)), asList());
    }
